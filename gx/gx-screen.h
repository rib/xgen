...
guint16 gx_screen_get_height (GXScreen *self);
guint16 gx_screen_get_width_in_millimeters (GXScreen *self);
guint16 gx_screen_get_height_in_millimeters (GXScreen *self);
/* FIXME GXVisualID is an autogenerated typedef
 * GXVisualID gx_screen_get_root_visual_id (GXScreen *self);
 */
guint8 gx_screen_get_backing_stores (GXScreen *self);
gboolean gx_screen_get_save_unders (GXScreen *self);
guint8 gx_screen_get_root_depth (GXScreen *self);
guint8 gx_screen_get_allowed_depths_len (GXScreen *self);
