...
static void gx_screen_class_init(GXScreenClass *klass);
...
GType
gx_screen_get_type(void) /* Typechecking */
{
  ...
  if (!self_type)
	...
	{
	  sizeof(GXScreenClass), /* class structure size */
	  NULL, /* base class initializer */
	  NULL, /* base class finalizer */
	  (GClassInitFunc)gx_screen_class_init, /* class initializer */
	  NULL, /* class finalizer */
	  NULL, /* class data */
	  sizeof(GXScreen), /* instance structure size */
	  0, /* preallocated instances */
	  (GInstanceInitFunc)gx_screen_init, /* instance initializer */
	  NULL /* function table */
	};
	...
	{
	  (GInterfaceInitFunc)
	    gx_screen_mydoable_interface_init,
		       ...
		       GParamSpec *pspec)
{
  ...
  switch(property_id)
    ...
    case PROP_NAME:
      ...
      gx_screen_set_property(self, g_value_get_uint(value));
      gx_screen_set_property(self, g_value_get_boolean(value));
      gx_screen_set_property(self, g_value_get_string(value));
      gx_screen_set_property(self, g_value_get_object(value));
      gx_screen_set_property(self, g_value_get_pointer(value));
      break;
#endif
    default:
...
#if 0
static void
gx_screen_mydoable_interface_init(gpointer interface,
				  gpointer data)
{
...
/**
 * gx_screen_get_PROPERTY:
 * @self:  A GXScreen.
 *
 * Fetches the PROPERTY of the GXScreen. FIXME, add more info!
 *
 * Returns: The value of PROPERTY. FIXME, add more info!
 */
PropType
gx_screen_get_PROPERTY(GXScreen *self)
{
  g_return_val_if_fail(GX_IS_SCREEN(self), /* FIXME */);
 ...
 */
void
gx_screen_set_PROPERTY(GXScreen *self, PropType PROPERTY)
{
  g_return_if_fail(GX_IS_SCREEN(self));
